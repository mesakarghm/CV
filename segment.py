# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 12:58:34 2019
...
def find_strawberry(image):
    ...
    ##Changing the order of the color in the memory
    image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
    
    #scale the image according to our requirements
    ...
    #converting the blurred image into hsv format
...
#write the new image 
cv2.imwrite("colors2.jpg",result)
